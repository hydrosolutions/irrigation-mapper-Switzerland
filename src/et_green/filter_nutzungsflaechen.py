...
def get_category1_crops() -> set:
    """
    Returns a set of crop types to use as category 1.
    """

    # TODO: Change when not validating
    rainfed_category1_set = {
        'Kartoffeln',
    ...
    return {normalize_string_client(crop) for crop in rainfed_category1_set}


def get_category2_crops() -> set:
    """
    Returns a set of crop types to use as category 2.
    """
    # TODO: Change when not validating
    rainfed_category2_set = {
        'Zuckerrüben',
        'Soja',
        'Tabak',
        'Körnermais'
    ...
    return {normalize_string_client(crop) for crop in rainfed_category2_set}
